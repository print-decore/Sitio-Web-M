...
function Header()
{
    ...
    $this->Cell(40,10,'Usos',1,0,'C',0,);

    $this->Cell(27,10,'Precio',1,0,'C',0);
...
$consulta = "SELECT user.id, user.nombre, user.usos, 
...
while ($row=$resultado->fetch_assoc()) {
    ...
    $pdf->Cell(40,10,$row['usos'],1,0,'C',0);

    $pdf->Cell(27,10,$row['precio'],1,0,'C',0);
